...
class InvalidParameterException(message: String, cause: Throwable? = null) : BadRequestException(message, cause)
...
class RepositoryInsertConflictException(message: String, cause: Throwable? = null) :
